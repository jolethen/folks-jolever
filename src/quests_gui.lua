...
function folks.quests.show_quest_log(player_name)
  ...
  local formspec = 
    ...
    "label[0.8,0.7;" .. core.colorize("#00f0ff", "TECHBLOX LOGBOOK") .. "]" ..
    "label[0.8,1.15;" .. core.colorize("#8899a6", "Manage ongoing tactical operations and terminal assignments") .. "]" ..
  ...
  for q_id, _ in pairs(pdata.active) do
    ...
    if cfg then
      ...
      formspec = formspec .. 
        "label[1.2," .. (row_y + 0.4) .. ";" .. core.colorize("#ffffff", cfg.title) .. "]" ..
        "label[1.2," .. (row_y + 0.8) .. ";" .. core.colorize("#5c6e7e", "OPERATIVE: " .. clean_giver) .. "]" ..
      ...
      formspec = formspec ..
        ...
        "label[8.6," .. (row_y + 0.6) .. ";" .. core.colorize("#ffaa00", "SECURED PAYLOAD") .. "]" ..
        "item_image[8.6," .. (row_y + 0.85) .. ";0.8,0.8;" .. cfg.reward_item .. "]" ..
        "label[9.6," .. (row_y + 1.35) .. ";" .. core.colorize("#ffffff", "x" .. cfg.reward_count .. " Gold") .. "]"
  ...
  if not has_active then
    formspec = formspec .. 
      ...
      "label[4.6,4.6;" .. core.colorize("#8899a6", "No active assignments found.") .. "]" ..
      "label[4.1,5.1;" .. core.colorize("#00f0ff", "Speak to folks at the docks to find work.") .. "]"
  end
